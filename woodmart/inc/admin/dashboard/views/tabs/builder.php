		...
		<div class="woodmart-column-inner">
			<div class="woodmart-box woodmart-box-shadow">
				<div class="woodmart-box-header">
					...
					<span class="woodmart-box-label <?php if ( whb_is_enabled() ): ?>woodmart-label-success<?php else: ?>woodmart-label-error<?php endif; ?>">
						<?php if ( whb_is_enabled() ): ?>
							<?php esc_html_e('Enabled', 'woodmart'); ?>
						<?php else: ?>
							<?php esc_html_e('Disabled', 'woodmart'); ?>
						<?php endif ?>
					</span>
				</div>
				<div class="woodmart-box-content">
					<div id="whb-header-builder"></div>
				</div>
