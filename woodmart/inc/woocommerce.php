...
if ( ! function_exists( 'woodmart_before_wishlist_button' ) ) {
	function woodmart_before_wishlist_button() {
		echo '<div class="wishlist-btn-wrapper">';
	}
}

if ( ! function_exists( 'woodmart_after_wishlist_button' ) ) {
	function woodmart_after_wishlist_button() {
		echo '</div>';
	}
}
...
if ( ! function_exists( 'woodmart_print_login_to_see' ) ) {
	function woodmart_print_login_to_see() {
		return '<a href="' . esc_url( get_permalink( wc_get_page_id( 'myaccount' ) ) ) . '" class="login-to-prices-msg">' . esc_html__( 'Login to see prices', 'woodmart' ) . '</a>';
	}
}