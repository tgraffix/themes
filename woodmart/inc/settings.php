    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            array (
                ...
                'subtitle' => esc_html__( 'Select page title section design on disable it completely on all pages.', 'woodmart' ),
                'options'  => array(
                    'default' => array(
            ...
            array (
                ...
                'options'  => array(
                    'popup' => array(
                        ...
                        'img' => WOODMART_ASSETS_IMAGES . '/settings/add-to-cart-action/popup.png'
                    ),
                    'widget' => array(
                        'title' => esc_html__( 'Display widget', 'woodmart' ),
                        'img' => WOODMART_ASSETS_IMAGES . '/settings/add-to-cart-action/widget.png'
                    ),
                    'nothing' => array(
                        'title' => esc_html__( 'No action', 'woodmart' ),
                        'img' => WOODMART_ASSETS_IMAGES . '/settings/add-to-cart-action/nothing.png'
                    ),
                ),
                'default' => 'widget',
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                'id'       => 'shop_categories',
                'type'     => 'switch',
                'title'    => esc_html__('Categories in page heading', 'woodmart'),
            ...
            array (
                ...
                'subtitle'     => esc_html__( 'If the category you visit doesn\'t contain any subcategories, the page heading menu will display this category\'s neighbors categories.', 'woodmart' ),
                'default' => 0,
                'required' => array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            ...
            array (
                ...
                'default'  => false,
                'required' => array(
                    array( 'single_product_style', 'equals', array( 1, 2, 3 ) ),
                )
            ),
            array (
