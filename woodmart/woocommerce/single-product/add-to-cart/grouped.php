...
//WC 3.4
$get_post_class = 'get_post_class';
if ( function_exists( 'WC' ) && WC()->version >= '3.4' ) {
	$get_post_class = 'wc_get_product_class';
}
					...
					foreach ( $grouped_product_columns as $column_id ) {
						...
						switch ( $column_id ) {
							...
							case 'quantity':
                                ...
                                echo '<td class="product-quantity" data-title="' . esc_attr( 'Quantity', 'woodmart' ) . '">';
								...
								break;
							case 'price':
                                $value = '<td class="price" data-title="' . esc_attr( 'Price', 'woodmart' ) . '">';
    							$value .= '<div>';
