...
function optionsframework_load_styles() {
	...
	wp_register_style( 'the7-options-gradient-picker', OPTIONS_FRAMEWORK_URL . 'js/gradient-picker/jquery.gradientPicker.css', false, THE7_VERSION );

	wp_enqueue_style( 'optionsframework', OPTIONS_FRAMEWORK_URL.'css/optionsframework.css', array( 'thickbox', 'wp-color-picker', 'the7-alpha-color-picker', 'the7-options-gradient-picker', 'optionsframework-jquery-ui', 'options-select2', 'the7-thickbox' ), THE7_VERSION );
...
function optionsframework_load_scripts($hook) {
	...
	// Gradient picker
	wp_register_script( 'the7-options-gradient-picker', OPTIONS_FRAMEWORK_URL . 'js/gradient-picker/jquery.gradientPicker.js', array( 'jquery', 'jquery-ui-draggable' ), THE7_VERSION, true );

	// Enqueue custom option panel JS
	wp_enqueue_script( 'options-custom', OPTIONS_FRAMEWORK_URL . 'js/options-custom.js', array( 'jquery', 'wp-color-picker', 'the7-alpha-color-picker', 'the7-options-gradient-picker', 'thickbox', 'options-select2', 'jquery-ui-core', 'jquery-ui-dialog', 'jquery-ui-slider', 'jquery-ui-widget', 'jquery-ui-sortable', 'jquery-form', 'jquery-ui-autocomplete' ), THE7_VERSION, true );
