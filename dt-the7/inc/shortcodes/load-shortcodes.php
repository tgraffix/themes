...
add_action( 'the7_before_footer_widgets_output', array( $orphaned_shortcodes_handler, 'add_hooks' ) );
add_action( 'the7_after_footer_widgets_output', array( $orphaned_shortcodes_handler, 'remove_hooks' ) );
add_action( 'the7_before_sidebar_widgets_output', array( $orphaned_shortcodes_handler, 'add_hooks' ) );
add_action( 'the7_after_sidebar_widgets_output', array( $orphaned_shortcodes_handler, 'remove_hooks' ) );
