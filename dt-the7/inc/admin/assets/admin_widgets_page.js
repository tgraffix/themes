...
/**
 * The7 Contact Form Widget dependency. Toggle terms message field visibility.
 *
 * @param el
 */
function the7ContactFormWidgetCheckTerms( el ) {
	var $textBlock = jQuery(el).parent().next('.the7-contact-form-widget-terms-msg-block');
	if (el.checked) {
		$textBlock.show();
	} else {
        $textBlock.hide();
